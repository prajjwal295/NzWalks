    ...
    public class NzWalksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                new Difficulty()
                {
                    Id=Guid.Parse("aa5ed211-cf6d-4513-8c45-347a51565f8f"),
                    Name = "Easy",
                },
                new Difficulty()
                {
                    Id=Guid.Parse("47ef0f95-2a3c-4c6c-b029-d9db3e5f4dee"),
                    Name="Medium",
                },
                new Difficulty()
                {
                    Id=Guid.Parse("614fd612-4d7b-4ee6-9c1a-f55e7bf051fd"),
                    Name="Hard",
                }
            };
